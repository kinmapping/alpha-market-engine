...
- Python側の strategy-module / execution-module を、`shared/domain/models/` でエンティティを共有する構成に移行・実装する。
...
- `docs/architecture/03_strategy_archi.md` と `docs/architecture/04_execution_archi.md` に同方針を反映し、各モジュール視点での後付け手順と環境変数例を整理
